               ...
               @forelse($categories as $category)
                    <div class="swiper-slide">
                        <a class="slider-category" href="{{ route('category.posts',$category->slug) }}">
                            <div class="blog-image"><img src="{{ asset('uploads/category/slider/'.$category->image)}}" alt="{{ $category->name }}"></div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card h-100">
                            <div class="single-post post-style-1">
                                ...
                                <div class="blog-image"><img src="{{ asset('uploads/post/'.$post->image)}}" alt="{{ $post->title }}"></div>
